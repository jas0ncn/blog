<template>
  <header class="flex column a-center">
    <div class="flex row a-center j-center aboutMe">
      <div class="flex row a-center links">
        <a href="https://ijason.cc" target="_blank">简历</a>
        <a href="http://github.com/jas0ncn" target="_blank">Github</a>
        <a href="https://www.zhihu.com/people/innojason" target="_blank">知乎</a>
        <a href="https://weibo.com/138604948" target="_blank">微博</a>
      </div>
      <div class="flex a-center j-center avatar">
